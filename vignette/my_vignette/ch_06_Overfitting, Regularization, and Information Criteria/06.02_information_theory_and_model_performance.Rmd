...
We can use a model's deviance to approximate the model's divergence. Below you are summing the logs of the likelihoof of each observed outcome in your data.
```{r}
...
(DEVIANCE_MODEL <- (-2) * sum(log(q))) %>% round(2)
```
...
*DEVIANCE should have been based on all observations rather than the 2 values of the model q, the values of q would accompany each observed outcome*